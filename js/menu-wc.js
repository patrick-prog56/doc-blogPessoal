                                ...
                                <a href="modules/AppModule.html" data-type="entity-link">AppModule</a>
                                    <li class="chapter inner">
                                        <div class="simple menu-toggler" data-toggle="collapse" ${ isNormalMode ?
                                            'data-target="#components-links-module-AppModule-fcc86d3fa5845992720fcea6482a0b1a"' : 'data-target="#xs-components-links-module-AppModule-fcc86d3fa5845992720fcea6482a0b1a"' }>
                                            <span class="icon ion-md-cog"></span>
                                            <span>Components</span>
                                            <span class="icon ion-ios-arrow-down"></span>
                                        </div>
                                        <ul class="links collapse" ${ isNormalMode ? 'id="components-links-module-AppModule-fcc86d3fa5845992720fcea6482a0b1a"' :
                                            'id="xs-components-links-module-AppModule-fcc86d3fa5845992720fcea6482a0b1a"' }>
                                            <li class="link">
